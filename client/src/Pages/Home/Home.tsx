		...
		<section className="home-section">
			<nav className={`home-top-bar ${themeContext?.theme}-top-bar`}>
				...
				<div className={`top-bar-button-panel`}>
					...
					<Link
						...
						className={`${themeContext?.theme}-theme-font`}
					>
						Log In
					</Link>
					<Link
			...
			<div className={`home-body ${themeContext?.theme}-home-body`}>
				<div className="home-presentation-section">
					<div
						className={`home-presentation ${themeContext?.theme}-presentation`}
					>
						<div
							className={`home-presentation-title ${themeContext?.theme}-presentation-title`}
						>
							<h2>Follow</h2>
							<h1>your passion!</h1>
						</div>
